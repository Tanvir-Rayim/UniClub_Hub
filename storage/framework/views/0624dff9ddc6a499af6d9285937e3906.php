...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0"><?php echo e($notifications->total()); ?> proposals awaiting your approval</p>
        </div>
        <?php if($notifications->count() > 0): ?>
            <a href="<?php echo e(route('advisor.notifications.index')); ?>" class="btn btn-outline-secondary">
                        ...
                        <div class="card-body p-0">
                            <div class="d-flex h-100">
                                ...
                                <div class="p-3 flex-grow-1">
                                    <div class="mb-2">
                                        ...
                                        <p class="mb-2 text-muted">
                                            <strong>Club:</strong> 
                                            <a href="<?php echo e(route('clubs.show', $notification->club)); ?>" class="text-decoration-none">
                                                <?php echo e($notification->club->name); ?>
                                    ...
                                    <div class="row mb-3 g-2">
                                        <div class="col-md-3">
                                            ...
                                            <small class="fw-bold"><?php echo e($notification->event->proposed_date->format('M d, Y')); ?></small>
                                        </div>
                                        <div class="col-md-3">
                                            <small class="text-muted d-block"><i class="fas fa-money-bill"></i> Budget</small>
                                            <small class="fw-bold">
                                                <?php echo e($notification->event->budget ? '$' . number_format($notification->event->budget, 2) : 'Not specified'); ?>

                                            </small>
                                        </div>
                                        <div class="col-md-3">
                                            <small class="text-muted d-block"><i class="fas fa-users"></i> Expected</small>
                                            <small class="fw-bold"><?php echo e($notification->event->expected_audience ?? 'Not specified'); ?></small>
                                        </div>
                                        <div class="col-md-3">
                                            <small class="text-muted d-block"><i class="fas fa-user"></i> Submitted by</small>
                                            <small class="fw-bold"><?php echo e($notification->event->creator->name); ?></small>
                                        </div>
                                    </div>

                                    <!-- Description -->
                                    <?php if($notification->event->description): ?>
                                        <p class="text-muted mb-0 small">
                                            <strong>Description:</strong><br>
                                            <?php echo e(Str::limit($notification->event->description, 150)); ?>
                                ...
                                <div class="p-3 text-center" style="min-width: 200px; display: flex; flex-direction: column; justify-content: center; gap: 0.5rem;">
                                    ...
                                    <form action="<?php echo e(route('events.approve', $notification->event)); ?>" method="POST" style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="btn btn-success btn-sm w-100">
                                            <i class="fas fa-check"></i> Approve
                                        </button>
                                    </form>
                                    <button class="btn btn-outline-danger btn-sm" onclick="showRejectModal(<?php echo e($notification->event->id); ?>)">
    ...
    <?php else: ?>
        ...
        <div class="text-center py-5">
            ...
            <a href="<?php echo e(route('advisor.notifications.index')); ?>" class="btn btn-outline-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\CSE470\UniClubHub\resources\views/advisor/notifications/pending.blade.php ENDPATH**/ ?>