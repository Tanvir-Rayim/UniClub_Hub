...
<?php $__env->startSection('title', 'Create Event Proposal - UniClub Hub'); ?>

<?php $__env->startSection('content'); ?>
<div class="container">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2 class="mb-0">Create Event Proposal</h2>
            <p class="text-muted">Submit a new event proposal for your club</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('events.store')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="club_id" id="club_id" class="form-select <?php $__errorArgs = ['club_id'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="venue_id" id="venue_id" class="form-select <?php $__errorArgs = ['venue_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = \App\Models\Venue::where('is_active', true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($venue->id); ?>" <?php echo e(old('venue_id') == $venue->id ? 'selected' : ''); ?>>
                                        <?php echo e($venue->name); ?> (Capacity: <?php echo e($venue->capacity); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" name="proposed_date" id="proposed_date" 
                                    class="form-control <?php $__errorArgs = ['proposed_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    value="<?php echo e(old('proposed_date')); ?>" required>
                                <?php $__errorArgs = ['proposed_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="budget" id="budget" class="form-control <?php $__errorArgs = ['budget'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('budget')); ?>" min="0" step="0.01">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="expected_audience" id="expected_audience" 
                                class="form-control <?php $__errorArgs = ['expected_audience'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body small">
                    <h6 class="mb-2">Before submitting:</h6>
                    <ul class="mb-0">
                        <li>Ensure you are assigned to the club</li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\CSE470\UniClubHub\resources\views/events/create.blade.php ENDPATH**/ ?>