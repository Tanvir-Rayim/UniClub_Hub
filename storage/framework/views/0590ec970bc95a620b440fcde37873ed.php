...
<?php $__env->startSection('title', $event->title . ' - Budget - UniClub Hub'); ?>

<?php $__env->startSection('content'); ?>
<div class="container">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2><?php echo e($event->title); ?> - Budget & Expenses</h2>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="stat-card text-center">
                                ...
                                <h3 class="text-primary">$<?php echo e(number_format($totalEstimated, 2)); ?></h3>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card text-center">
                                <h6 class="text-muted">Total Expenses</h6>
                                <h3 class="text-success">$<?php echo e(number_format($totalExpenses, 2)); ?></h3>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card text-center">
                                <h6 class="text-muted">Remaining</h6>
                                <h3 class="<?php echo e($totalEstimated - $totalExpenses >= 0 ? 'text-info' : 'text-danger'); ?>">
                                    $<?php echo e(number_format($totalEstimated - $totalExpenses, 2)); ?>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $budgetItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <strong><?php echo e($item->item_description); ?></strong>
                                                <?php if($item->notes): ?>
                                                    <br><small class="text-muted"><?php echo e($item->notes); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>$<?php echo e(number_format($item->estimated_amount, 2)); ?></td>
                                            <td>
                                                <?php if($item->actual_amount): ?>
                                                    $<?php echo e(number_format($item->actual_amount, 2)); ?>
                                            ...
                                            <td>
                                                <?php if($item->actual_amount): ?>
                                                    ...
                                                    ?>
                                                    <span class="badge <?php echo e($diff >= 0 ? 'bg-danger' : 'bg-success'); ?>">
                                                        <?php echo e($diff >= 0 ? '+' : ''); ?>$<?php echo e(number_format($diff, 2)); ?>
                    ...
                    <?php if($expenseProofs->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $expenseProofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <strong><?php echo e($proof->description); ?></strong>
                                                <?php if($proof->notes): ?>
                                                    <br><small class="text-muted"><?php echo e($proof->notes); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td><strong>$<?php echo e(number_format($proof->amount, 2)); ?></strong></td>
                                            <td>
                                                <span class="badge bg-secondary"><?php echo e(ucfirst(str_replace('_', ' ', $proof->file_type))); ?></span>
                                            </td>
                                            <td>
                                                <?php if($proof->budgetItem): ?>
                                                    <?php echo e($proof->budgetItem->item_description); ?>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body small">
                    ...
                    <p><strong>Proposed Date:</strong> <?php echo e($event->proposed_date->format('M d, Y')); ?></p>
                    <p><strong>Venue:</strong> <?php echo e($event->venue?->name ?? 'Not assigned'); ?></p>
                </div>
            </div>
...
<div class="modal fade" id="addBudgetModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('events.budget.store', $event)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['item_description'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?php $__errorArgs = ['estimated_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        <?php $__errorArgs = ['estimated_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<div class="modal fade" id="uploadExpenseModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('events.expenses.store', $event)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="budget_item_id" name="budget_item_id">
                            ...
                            <?php $__currentLoopData = $budgetItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>"><?php echo e($item->item_description); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="file_type" class="form-label">Document Type</label>
                        <select class="form-select <?php $__errorArgs = ['file_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="file_type" name="file_type" required>
...
document.querySelectorAll('.edit-budget-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        document.getElementById('editBudgetForm').action = `/events/<?php echo e($event->id); ?>/budget-items/${id}`;
    });
});
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\CSE470\UniClubHub\resources\views/budgets/show.blade.php ENDPATH**/ ?>