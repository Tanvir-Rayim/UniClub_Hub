...
<?php $__env->startSection('title', 'Financial Summary - Admin Dashboard'); ?>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-top: 4px solid #10b981;">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1">$<?php echo e(number_format($totalApprovedBudget, 2)); ?></h2>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-top: 4px solid #3b82f6;">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1">$<?php echo e(number_format($totalReleasedBudget, 2)); ?></h2>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $clubData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $club): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="ps-4"><strong><?php echo e($club['name']); ?></strong></td>
                                        <td><?php echo e($club['total_approved_events']); ?></td>
                                        <td>$<?php echo e(number_format($club['total_budget'], 2)); ?></td>
                                        <td>
                                            ...
                                            <small class="text-muted">$<?php echo e(number_format($club['released_budget'], 2)); ?></small>
                                        </td>
                                        <td>
                                            <?php if($club['pending_release'] > 0): ?>
                                                <span class="badge bg-warning text-dark"><?php echo e($club['pending_release']); ?> Pending Release</span>
                                            <?php else: ?>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                        ...
                        <?php $__currentLoopData = $recentEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item p-3">
                                <div class="d-flex w-100 justify-content-between mb-1">
                                    ...
                                    <small class="text-muted">$<?php echo e(number_format($event->budget, 0)); ?></small>
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-primary"><?php echo e($event->club->name); ?></small>
                ...
                <div class="card-footer bg-white text-center">
                    <a href="<?php echo e(route('events.index')); ?>" class="text-decoration-none small">View All Events <i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\CSE470\UniClubHub\resources\views/admin/financial-summary.blade.php ENDPATH**/ ?>