    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="text-end">
                    <a href="{{ route('clubs.index') }}" class="btn btn-primary btn-lg mb-2 shadow-sm">
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-top: 4px solid #f5576c;">
                <div class="card-body text-center p-4">
                    <div class="display-5 fw-bold text-danger mb-2">{{ $pendingApplications }}</div>
                    ...
                    @if ($clubs->count() > 0)
                        <div class="list-group list-group-flush">
                            @foreach ($clubs as $club)
                                <a href="{{ route('clubs.show', $club) }}" class="list-group-item list-group-item-action p-4 border-bottom border-light">
                                    <div class="d-flex w-100 justify-content-between align-items-center mb-2">
                                        <h6 class="mb-0 fw-bold text-dark">{{ $club->name }}</h6>
                                        <span class="badge bg-light text-secondary border">
                                            <i class="far fa-clock me-1"></i>
                                            Joined {{ $club->pivot->joined_at ? $club->pivot->joined_at->diffForHumans() : 'Recently' }}
                                        </span>
                                    </div>
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-500">{{ $user->university_id }}</span>
                            </div>
                        </li>
                        <li class="mb-3">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-3">
                    <div class="d-grid gap-2">
                        <a href="{{ route('clubs.index') }}" class="btn btn-outline-primary text-start px-3 py-2">
                            <i class="fas fa-search me-2" style="width: 20px;"></i> Browse Clubs
                        </a>
                        <a href="{{ route('profile.show') }}" class="btn btn-outline-secondary text-start px-3 py-2">
                            <i class="fas fa-user me-2" style="width: 20px;"></i> View Profile
                        </a>
                        <a href="{{ route('profile.edit') }}" class="btn btn-outline-secondary text-start px-3 py-2">
