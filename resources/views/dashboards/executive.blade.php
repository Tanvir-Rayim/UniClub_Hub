...
@section('title', 'Executive Dashboard - UniClub Hub')
    ...
    <div class="row g-4 mb-5">
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-top: 4px solid #667eea;">
                <div class="card-body text-center">
                    <div class="display-5 fw-bold text-primary mb-2">{{ $activeClubsCount }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-top: 4px solid #764ba2;">
                <div class="card-body text-center">
                    <div class="display-5 fw-bold text-info mb-2">{{ $totalMembers }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-top: 4px solid #f5576c;">
                <div class="card-body text-center">
                    <div class="display-5 fw-bold text-danger mb-2">{{ $proposedEventsCount }}</div>
                ...
                <div class="card-body">
                    <div class="row g-2">
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ route('events.index') }}" class="btn btn-outline-primary w-100 py-2">
                        ...
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ route('attendance.pending') }}" class="btn btn-outline-success w-100 py-2">
                ...
                <div class="card-body p-0">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @foreach ($clubs as $club)
                                        <tr>
                                            <td class="ps-4">
                                                <a href="{{ route('clubs.show', $club) }}" class="text-decoration-none fw-500">
                                                    {{ $club->name }}
                                                </a>
                                            </td>
                                            <td>
                                                <span class="badge bg-info rounded-pill">{{ $club->getActiveMembersCount() }}</span>
                                            </td>
                                            <td>
                                                <small>{{ $club->advisors?->name ?? 'Not Assigned' }}</small>
                                            </td>
                                            <td>
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('clubs.index') }}" class="btn btn-primary">Browse Clubs</a>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="card-body p-0">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @foreach ($proposedEvents as $event)
                                        <tr>
                                            <td class="ps-4">
                                                <a href="{{ route('events.show', $event) }}" class="text-decoration-none fw-500">
                                                    {{ $event->title }}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <small>{{ $event->proposed_date->format('M d, Y') }}</small>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if ($event->financial_release_status)
                                                    <span class="badge bg-success" title="Released at {{ $event->financial_released_at->format('M d, Y') }}">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('events.create') }}" class="btn btn-primary">Create Event Proposal</a>
                        </div>
                    @endif
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <p class="fw-500 mb-0">{{ $user->university_id }}</p>
                        </div>
                        <div class="col-12">
                            <label class="small text-muted d-block mb-1">Email Address</label>
                            <p class="fw-500 mb-0">{{ $user->email }}</p>
                        </div>
                        <div class="col-12">
